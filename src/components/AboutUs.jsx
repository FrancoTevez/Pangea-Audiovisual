    ...
    <section className='SectionNosotros'>
        <div style={{display: "flex", justifyContent: "center", background: "#4144B8"}}>
            <div className='contNosotros'>
                ...
                <p className='parrafoServicios'>Agradecemos estar sumergidos en este rubro, porque constantemente nos brinda conocimientos invaluables para elevar la calidad de nuestros <Link to="/" onClick={() => scrollToSection("servicios")} className='linkToServicios'>servicios.</Link></p>
            </div>
        </div>
        <VectorAzul />
    </section>
